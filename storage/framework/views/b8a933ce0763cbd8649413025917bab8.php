<?php $__env->startSection('content'); ?>
    <div class="container">
        ...
        <form action="<?php echo e(route('admin.petitions.update', $petition->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="description" name="description" rows="4" required><?php echo e(old('description', $petition->description)); ?></textarea>
            </div>

            <!-- Destinatario -->
            <div class="mb-3">
                <label for="addressee" class="form-label">Destinatario</label>
                <input type="text" class="form-control" id="addressee" name="addressee" value="<?php echo e(old('addressee', $petition->addressee)); ?>" required>
            </div>

            <!-- Firmantes -->
            <div class="mb-3">
                <label for="signatories" class="form-label">Firmantes</label>
                <input type="number" class="form-control" id="signatories" name="signatories" value="<?php echo e(old('signatories', $petition->signatories)); ?>" min="0">
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="status" name="status" required>
                    <option value="pending" <?php echo e(old('status', $petition->status) == 'pending' ? 'selected' : ''); ?>>Pending</option>
                    <option value="accepted" <?php echo e(old('status', $petition->status) == 'accepted' ? 'selected' : ''); ?>>Accepted</option>
                </select>
            </div>
                ...
                <div class="d-flex flex-wrap gap-3">
                    <?php $__currentLoopData = $petition->files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="position-relative">
                            <img src="<?php echo e(asset($file->file_path)); ?>" alt="<?php echo e($file->name); ?>" width="150" class="img-thumbnail">
                            <form action="<?php echo e(route('admin.petitions.delete', $file->id)); ?>" method="POST" class="position-absolute top-0 end-0">
                                <?php echo csrf_field(); ?>

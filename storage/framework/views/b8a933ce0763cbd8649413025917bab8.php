        ...
        <form action="<?php echo e(route('admin.petitions.update', $petition->id)); ?>"
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="status" required>
                    <option value="pending" <?php echo e($petition->status == 'pending' ? 'selected' : ''); ?>>Pending</option>
                    <option value="accepted" <?php echo e($petition->status == 'accepted' ? 'selected' : ''); ?>>Accepted</option>
                </select>
            </div>
            ...
            <a href="<?php echo e(route('admin.petitions.show')); ?>" class="btn btn-secondary">
                Volver al listado
            </a>
        </form>
